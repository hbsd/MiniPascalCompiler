...
public class StoreArg extends AbstractTAInst
{
    QualifiedVariable var;
    TAValue val;
    public StoreArg(QualifiedVariable var, TAValue val, String label)
    {
    ...
    public StoreArg(QualifiedVariable var, TAValue val)
    {
        this(var, val, null);
    }
    ...
    {
        return String.format("%s\tArg(%s) = %s", getLabel(), var.getQualifiedName(), val);
    }
}
